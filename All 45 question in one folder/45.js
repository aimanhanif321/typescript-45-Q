...
let famous_Quote = "Mother Terres";
...
let famous_Quote2 = "Mother Terres";
let message1 = "if you judge people you never have time to love them";
...
console.log('\nQuestion # 11 is:');
let names = [`Aiman`, `Haider`, `Alaya`, `Arif`];
...
console.log('\nQuestion # 12 is:');
let names1 = [`Aiman`, `Haider`, `Alaya`, `arif`];
 ...
 */
console.log("\nQUESTION # 14 & 15");
let guestList = ["sharukh khan", "salman khan", "Amir khan"];
...
let array = ["pakistan", "india", "france"];
...
console.log("Equality test with number:(2 as number) !== 2 =", 2 !== 2);
...
let username = ["Alina", "Ahmed", "Admin", "Ali", "Rana"];
...
let new_users = ["User1", "User6", "user7", "user2", "User8"];
...
let pizzas = ["chicken tikka", "fajita ", "pepproni"];
...
let magician1 = ["magician1", "magician2", "magician3", "magician4"];
...
function make_sandwich(items) {
    ...
    // items 
    items.forEach(ingrediants => console.log(`- ${ingrediants}`));
}
...
// / QUESTION # 45
console.log("\n QUESTION # 45");
function carInformation(manufacturer, model, ...option) {
